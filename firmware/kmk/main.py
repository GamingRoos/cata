...
keyboard.modules = [layers_ext, oneshot_ext]
keyboard.extensions = [media_keys, international]
...
keyboard.keymap = [
    ...
    [   # Navigation
        ...
        KC.ESC,  KC.TAB,  KC.ENT,  KC.BSPC, KC.NO,   KC.PAUS, KC.LEFT, KC.DOWN, KC.UP,   KC.RGHT,
        OS_LGUI, OS_LALT, OS_LSFT, OS_LCTL, KC.NO,   KC.NO,   OS_RCTL, OS_RSFT, OS_RALT, OS_RGUI,
                                   KC.TRNS, KC.TRNS, KC.TRNS, FUN
    ],
    [   # Function
        KC.F1,   KC.F2,   KC.F3,   KC.F4,   KC.NO,   KC.SLCK, KC.MPLY, KC.MPRV, KC.MNXT, KC.BRIU,
        KC.F5,   KC.F6,   KC.F7,   KC.F8,   KC.NO,   KC.CLCK, KC.MUTE, KC.VOLD, KC.VOLU, KC.BRID,
        KC.F9,   KC.F10,  KC.F11,  KC.F12,  KC.NO,   KC.NLCK, OS_RCTL, OS_RSFT, OS_RALT, OS_RGUI,
