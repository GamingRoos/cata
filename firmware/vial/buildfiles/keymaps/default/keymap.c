...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SYMBOL] = LAYOUT_split_3x5_2(
        ...
        KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL, XXXXXXX, XXXXXXX, KC_RCTL, KC_RSFT, KC_RALT, KC_RGUI,
    ...
    [_FUNCTION] = LAYOUT_split_3x5_2(
        ...
        KC_LGUI, KC_LALT, KC_LSFT, KC_LCTL, XXXXXXX, KC_NUM,  KC_RCTL, KC_RSFT, KC_RALT, KC_RGUI,
